...
enum retcode_t {
  ...
  RC_SQLITE3_FAILED_OPEN_DB = 0x01 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_FATAL,
  RC_SQLITE3_FAILED_INSERT_DB = 0x02 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_CREATE_INDEX_DB = 0x03 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_WRITE_STATEMENT = 0x04 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_SELECT_DB = 0x05 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_NO_PATH_FOR_DB_SPECIFIED = 0x06 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_FATAL,
  RC_SQLITE3_FAILED_NOT_IMPLEMENTED = 0x07 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_START_TRANSACTION = 0x08 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_END_TRANSACTION = 0x09 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_BINDING = 0x0A | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_PREPARED_STATEMENT = 0x0B | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_FINALIZE = 0x0C | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_STEP = 0x0D | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_BEGIN = 0x0E | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_END = 0x0F | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_ROLLBACK = 0x10 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_FATAL,
  RC_SQLITE3_FAILED_CONFIG = 0x11 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_FATAL,
  RC_SQLITE3_FAILED_INITIALIZE = 0x12 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_FATAL,
  RC_SQLITE3_FAILED_SHUTDOWN = 0x13 | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_FATAL,

  // Storage SQL Module
  RC_SQL_FAILED_WRITE_STATEMENT = 0x01 | RC_MODULE_STORAGE_SQL | RC_SEVERITY_MAJOR,
  ...
  RC_CORE_FAILED_DATABASE_DESTROY = 0x03 | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_FAILED_MILESTONE_TRACKER_INIT = 0x04 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_MILESTONE_TRACKER_START = 0x05 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_MILESTONE_TRACKER_STOP = 0x06 | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_FAILED_MILESTONE_TRACKER_DESTROY = 0x07 | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  ...
  RC_CORE_FAILED_SNAPSHOT_DESTROY = 0x11 | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  RC_CORE_FAILED_LEDGER_VALIDATOR_INIT = 0x12 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_LEDGER_VALIDATOR_DESTROY = 0x13 | RC_MODULE_CORE | RC_SEVERITY_MODERATE,
  ...
  RC_CORE_FAILED_API_HTTP_INIT = 0x19 | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_API_HTTP_START = 0x1A | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_API_HTTP_STOP = 0x1B | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  RC_CORE_FAILED_API_HTTP_DESTROY = 0x1C | RC_MODULE_CORE | RC_SEVERITY_FATAL,
  ...
  RC_NODE_FAILED_BROADCASTER_STOP = 0x07 | RC_MODULE_NODE | RC_SEVERITY_MODERATE,
  RC_NODE_FAILED_BROADCASTER_DESTROY = 0x08 | RC_MODULE_NODE | RC_SEVERITY_MODERATE,
  ...
  RC_NODE_FAILED_PROCESSOR_DESTROY = 0x0C | RC_MODULE_NODE | RC_SEVERITY_MODERATE,
  ...
  RC_NODE_FAILED_RECEIVER_DESTROY = 0x10 | RC_MODULE_NODE | RC_SEVERITY_MODERATE,
  ...
  RC_NODE_FAILED_RESPONDER_DESTROY = 0x16 | RC_MODULE_NODE | RC_SEVERITY_MODERATE,
  RC_NODE_FAILED_REQUESTER_INIT = 0x17 | RC_MODULE_NODE | RC_SEVERITY_FATAL,
  RC_NODE_FAILED_REQUESTER_DESTROY = 0x18 | RC_MODULE_NODE | RC_SEVERITY_MODERATE,
  ...
  RC_NEIGHBOR_FAILED_URI_PARSING = 0x06 | RC_MODULE_NEIGHBOR | RC_SEVERITY_MAJOR,
  ...
  RC_NEIGHBOR_FAILED_ENDPOINT_INIT = 0x0B | RC_MODULE_NEIGHBOR | RC_SEVERITY_FATAL,
  RC_NEIGHBOR_FAILED_ENDPOINT_DESTROY = 0x0C | RC_MODULE_NEIGHBOR | RC_SEVERITY_FATAL,
  ...
  RC_CONSENSUS_CW_FAILED_IN_DFS_FROM_DB = 0x02 | RC_MODULE_CONSENSUS_CW | RC_SEVERITY_MAJOR,
  RC_CONSENSUS_CW_FAILED_IN_LIGHT_DFS = 0x03 | RC_MODULE_CONSENSUS_CW | RC_SEVERITY_MAJOR,
  ...
  RC_CONSENSUS_EXIT_PROBABILITIES_MISSING_RATING = 0x07 | RC_MODULE_CONSENSUS_EXIT_PROBABILITIES | RC_SEVERITY_MODERATE,

  RC_CONSENSUS_NULL_BUNDLE_PTR = 0x08 | RC_MODULE_CONSENSUS_CW | RC_SEVERITY_MAJOR,
  ...
  RC_UTILS_FAILED_WRITE_FILE = 0x08 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_FAILED_READ_FILE = 0x09 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  // Utils Socket
  RC_UTILS_SOCKET_TLS_RNG = 0x0A | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_CA = 0x0B | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_CLIENT_PEM = 0x0C | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_CLIENT_PK = 0x0D | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_CONF = 0x0E | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_AUTHMODE = 0x0F | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_CLIENT_AUTH = 0x10 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_TLS_HANDSHAKE = 0x11 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_CONNECT = 0x12 | RC_MODULE_UTILS | RC_SEVERITY_MAJOR,
  RC_UTILS_SOCKET_RECV = 0x13 | RC_MODULE_UTILS | RC_SEVERITY_MINOR,
  ...
  RC_RECEIVER_COMPONENT_NULL_STATE = 0x01 | RC_MODULE_RECEIVER_COMPONENT | RC_SEVERITY_FATAL,
  RC_RECEIVER_COMPONENT_NULL_NODE = 0x02 | RC_MODULE_RECEIVER_COMPONENT | RC_SEVERITY_FATAL,
  RC_RECEIVER_COMPONENT_FAILED_THREAD_SPAWN = 0x03 | RC_MODULE_RECEIVER_COMPONENT | RC_SEVERITY_FATAL,
  RC_RECEIVER_COMPONENT_FAILED_THREAD_JOIN = 0x04 | RC_MODULE_RECEIVER_COMPONENT | RC_SEVERITY_MODERATE,
  RC_RECEIVER_COMPONENT_STILL_RUNNING = 0x05 | RC_MODULE_RECEIVER_COMPONENT | RC_SEVERITY_FATAL,
  RC_RECEIVER_COMPONENT_INVALID_PROCESSOR = 0x06 | RC_MODULE_RECEIVER_COMPONENT | RC_SEVERITY_FATAL,

  // Requester component module
  RC_REQUESTER_COMPONENT_NULL_STATE = 0x01 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_FATAL,
  RC_REQUESTER_COMPONENT_NULL_TANGLE = 0x02 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_FATAL,
  RC_REQUESTER_COMPONENT_NULL_HASH = 0x03 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_FATAL,
  RC_REQUESTER_COMPONENT_FAILED_INIT_LIST = 0x04 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_FATAL,
  RC_REQUESTER_COMPONENT_FAILED_DESTROY_LIST = 0x05 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_MODERATE,
  RC_REQUESTER_COMPONENT_FAILED_ADD_LIST = 0x06 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_MINOR,
  RC_REQUESTER_COMPONENT_FAILED_REMOVE_LIST = 0x07 | RC_MODULE_REQUESTER_COMPONENT | RC_SEVERITY_MINOR,

  // Responder component module
  RC_RESPONDER_COMPONENT_FAILED_TX_PROCESSING = 0x0D | RC_MODULE_RESPONDER_COMPONENT | RC_SEVERITY_MINOR,
  RC_RESPONDER_COMPONENT_FAILED_REQ_PROCESSING = 0x0E | RC_MODULE_RESPONDER_COMPONENT | RC_SEVERITY_MINOR,
  RC_RESPONDER_COMPONENT_INVALID_TX = 0x0F | RC_MODULE_RESPONDER_COMPONENT | RC_SEVERITY_MODERATE,

  // Gossip module
  RC_GOSSIP_SET_PACKET_TRANSACTION_FAILED = 0x01 | RC_MODULE_GOSSIP | RC_SEVERITY_MODERATE,
  RC_GOSSIP_SET_PACKET_REQUEST_FAILED = 0x02 | RC_MODULE_GOSSIP | RC_SEVERITY_MODERATE,
  ...
  RC_CONSENSUS_MT_NULL_TANGLE = 0x02 | RC_MODULE_CONSENSUS_MT | RC_SEVERITY_FATAL,
  RC_CONSENSUS_MT_FAILED_THREAD_SPAWN = 0x03 | RC_MODULE_CONSENSUS_MT | RC_SEVERITY_FATAL,
  RC_CONSENSUS_MT_FAILED_THREAD_JOIN = 0x04 | RC_MODULE_CONSENSUS_MT | RC_SEVERITY_MODERATE,
  RC_CONSENSUS_MT_STILL_RUNNING = 0x05 | RC_MODULE_CONSENSUS_MT | RC_SEVERITY_FATAL,
  ...
  RC_API_FIND_TRANSACTIONS_NO_INPUT = 0x3 | RC_MODULE_API | RC_SEVERITY_MODERATE,
  ...
  RC_API_INVALID_COMMAND = 0x09 | RC_MODULE_API | RC_SEVERITY_MINOR,
  RC_API_GET_BALANCES_INVALID_THRESHOLD = 0x0A | RC_MODULE_API | RC_SEVERITY_MINOR,
  RC_API_GET_BALANCES_UNKNOWN_TIP = 0x0B | RC_MODULE_API | RC_SEVERITY_MINOR,
  RC_API_GET_BALANCES_INCONSISTENT_TIP = 0x0B | RC_MODULE_API | RC_SEVERITY_MINOR,

  // Snapshot Module
  RC_SNAPSHOT_NULL_SELF = 0x01 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_NULL_STATE = 0x02 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_NULL_HASH = 0x03 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_NULL_BALANCE = 0x04 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_FILE_NOT_FOUND = 0x05 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INVALID_FILE = 0x06 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INVALID_SUPPLY = 0x07 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INCONSISTENT_SNAPSHOT = 0x08 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_OOM = 0x09 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_INCONSISTENT_PATCH = 0x0A | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MAJOR,
  RC_SNAPSHOT_BALANCE_NOT_FOUND = 0x0B | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_INVALID_SIGNATURE = 0x0C | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_FAILED_JSON_PARSING = 0x0D | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_LOCAL_SNAPSHOTS_MANAGER_NULL_SELF = 0x0E | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_LOCAL_SNAPSHOTS_MANAGER_FAILED_THREAD_SPAWN = 0x0F | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_FATAL,
  RC_SNAPSHOT_LOCAL_SNAPSHOTS_MANAGER_FAILED_THREAD_JOIN = 0x10 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_LOCAL_SNAPSHOTS_MANAGER_STILL_RUNNING = 0x11 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,
  RC_SNAPSHOT_LOCAL_SNAPSHOTS_NOT_ENOUGH_DEPTH = 0x12 | RC_MODULE_CONSENSUS_SNAPSHOT | RC_SEVERITY_MODERATE,

  // Ledger Validator Module
  RC_LEDGER_VALIDATOR_NULL_PTR = 0x01 | RC_MODULE_LEDGER_VALIDATOR | RC_SEVERITY_FATAL,
  RC_LEDGER_VALIDATOR_INVALID_TRANSACTION = 0x02 | RC_MODULE_LEDGER_VALIDATOR | RC_SEVERITY_MAJOR,
  RC_LEDGER_VALIDATOR_OOM = 0x03 | RC_MODULE_LEDGER_VALIDATOR | RC_SEVERITY_FATAL,
  RC_LEDGER_VALIDATOR_COULD_NOT_LOAD_MILESTONE = 0x04 | RC_MODULE_LEDGER_VALIDATOR | RC_SEVERITY_MAJOR,
  RC_LEDGER_VALIDATOR_INCONSISTENT_DELTA = 0x05 | RC_MODULE_LEDGER_VALIDATOR | RC_SEVERITY_FATAL,
  RC_LEDGER_VALIDATOR_TRANSACTION_NOT_SOLID = 0x06 | RC_MODULE_LEDGER_VALIDATOR | RC_SEVERITY_FATAL,

  // Tip Selector Module
  RC_TIP_SELECTOR_TIPS_NOT_CONSISTENT = 0x01 | RC_MODULE_CONSENSUS_TIP_SELECTOR | RC_SEVERITY_MODERATE,
  RC_TIP_SELECTOR_REFERENCE_TOO_OLD = 0x02 | RC_MODULE_CONSENSUS_TIP_SELECTOR | RC_SEVERITY_MODERATE,
  ...
  RC_MAM_PB3_SIZE_T_NOT_SUPPORTED = 0x0E | RC_MODULE_MAM | RC_SEVERITY_MODERATE,
  ...
  RC_MAM_PK_IS_NOT_TRUSTED = 0x20 | RC_MODULE_MAM | RC_SEVERITY_MODERATE,
  RC_MAM_MSS_NOT_FOUND = 0x21 | RC_MODULE_MAM | RC_SEVERITY_MODERATE,
